...
namespace SLGIS.Web.Pages.Computer
{
    public class NewOrEditModel : PageModel
    {
        ...
        public NewOrEditModel(ILogger<NewOrEditModel> logger, IComputerRepository computerRepository)
        {
            _logger = logger;
        ...
        [BindProperty]
        public SLGIS.Core.Computer Computer { get; set; }

        public async Task OnGet(Guid? id = null)
        {
            Computer = new SLGIS.Core.Computer();
